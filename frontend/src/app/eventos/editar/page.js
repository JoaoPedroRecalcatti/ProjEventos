    ...
    return (
        <div className="mx-auto max-w-3xl">
            ...
            <form className="mt-8 grid gap-5 sm:grid-cols-2">
                ...
                <Campo rotulo="Local" placeholder="Dourados/MS" />
                ...
                <div className="flex items-center gap-3 rounded-xl border border-borda px-4 py-3.5">
                    <span className="relative h-[22px] w-[38px] shrink-0 rounded-full bg-elevado">
                        <span className="absolute left-[3px] top-[3px] h-4 w-4 rounded-full bg-fraco"></span>
                    </span>
                    <span>
                ...
                <div className="flex items-center gap-3 rounded-xl border border-borda px-4 py-3.5">
                    <span className="relative h-[22px] w-[38px] shrink-0 rounded-full bg-texto">
                        <span className="absolute right-[3px] top-[3px] h-4 w-4 rounded-full bg-fundo"></span>
                    </span>
                    <span>
