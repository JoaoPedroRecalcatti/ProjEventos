export default function Campo({ ref, rotulo, placeholder, tipo, auxiliar, linhas }) {
    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            {linhas
                ? <textarea ref={ref} rows={linhas} placeholder={placeholder} className={`${classes} resize-y leading-relaxed`} />
                : <input ref={ref} type={tipo || "text"} placeholder={placeholder} className={classes} />}
